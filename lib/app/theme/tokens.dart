...
class JmColors extends ThemeExtension<JmColors> {
  ...
  static const light = JmColors(
    // Brand, a notch deeper and less saturated than pure cobalt/azure so
    // large fills read polished rather than neon.
    ocean: Color(0xFF2B5CE6),
    sky: Color(0xFF2E9BEB),
    match: Color(0xFF1DA867),
    // Warm amber instead of pure yellow — same "marker" job, far less glare.
    volt: Color(0xFFF5C518),
    oceanDeep: Color(0xFF1E44B8),
    skyDeep: Color(0xFF0F6BC2),
    matchDeep: Color(0xFF0E7A48),
    voltDeep: Color(0xFF7A5A00),
    oceanTint: Color(0xFFE8EEFC),
    skyTint: Color(0xFFE3F2FC),
    matchTint: Color(0xFFDFF5E9),
    voltTint: Color(0xFFFFF4CC),
    danger: Color(0xFFD9342B),
    dangerTint: Color(0xFFFDE8E6),
    warn: Color(0xFFD97706),
    warnTint: Color(0xFFFFF1DB),
    // Neutrals: near-black ink with a hint of navy; the page is a cool
    // off-white so white cards lift off it without heavy borders.
    ink: Color(0xFF141C2E),
    text: Color(0xFF2B3445),
    muted: Color(0xFF5F6B80),
    faint: Color(0xFF93A0B4),
    line: Color(0xFFE3E8F1),
    lineStrong: Color(0xFFCBD4E3),
    surface: Color(0xFFEEF1F8),
    surface2: Color(0xFFE4E9F3),
    ground: Color(0xFFF7F8FC),
    card: Color(0xFFFFFFFF),
    focus: Color(0xFF2E9BEB),
    codeBg: Color(0xFF141C2E),
    codeFg: Color(0xFFDCE8F2),
    shadow: [
      BoxShadow(color: Color(0x0F141C2E), offset: Offset(0, 1), blurRadius: 2),
      BoxShadow(color: Color(0x14141C2E), offset: Offset(0, 6), blurRadius: 20),
    ],
  );
